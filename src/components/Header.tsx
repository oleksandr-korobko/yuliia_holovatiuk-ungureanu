      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            <MobileNavItem href="/articles">Main</MobileNavItem> {/* посилання на сторінку */}
            <MobileNavItem href="/about">About</MobileNavItem>
            <MobileNavItem href="/projects">Projects</MobileNavItem>
            <MobileNavItem href="/speaking">Exhibitions & Events</MobileNavItem> {/* посилання на сторінку */}
            {/* <MobileNavItem href="/blog">Blog</MobileNavItem> */}
            <MobileNavItem href="/uses">Contacts</MobileNavItem> {/* посилання на сторінку */}
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 ring-1 shadow-lg shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/articles">Main</NavItem> {/* посилання на сторінку */}
        <NavItem href="/about">About</NavItem>
        <NavItem href="/projects">Projects</NavItem>
        <NavItem href="/speaking">Exhibitions & Events</NavItem>{/* посилання на сторінку */}
        {/* <NavItem href="/blog">Blog</NavItem> */}
        <NavItem href="/uses">Contacts</NavItem> {/* посилання на сторінку */}
      </ul>
    </nav>
  )
}
